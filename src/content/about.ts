export const about = {
  ...
  music: {
    ...
    subline: "Pick a vibe, then press play.",
    vibes: ["Rainy day", "Focus", "Road trip", "Sunday morning"],
    note: "Guests hear 30-second previews. Log in to Spotify for full tracks.",
  },
  travel: {
    title: "My travel memories",
    subline: "A playground of photos from the places I have been.",
    cta: { label: "Enter the playground", href: "/playground" },
  },
};
